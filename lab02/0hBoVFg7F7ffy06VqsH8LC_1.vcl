...
pragma optional_param customer_id "17HqYqzbBggBAijdZMAZYb";
C!
W!
# Backends

backend F_AWS_S3_hosting {
    .between_bytes_timeout = 10s;
    .connect_timeout = 1s;
    .dynamic = true;
    .first_byte_timeout = 15s;
    .host = "lab-development-lab2.s3-website-us-east-1.amazonaws.com";
    .max_connections = 200;
    .port = "80";
    .share_key = "0hBoVFg7F7ffy06VqsH8LC";


    .probe = {
        .dummy = true;
        .initial = 5;
        .request = "HEAD / HTTP/1.1"  "Host: lab-development-lab2.s3-website-us-east-1.amazonaws.com" "Connection: close";
        .threshold = 1;
        .timeout = 2s;
        .window = 5;
      }
...
#--FASTLY RECV BEGIN
  if (req.restarts == 0) {
    ...
    set req.http.host = "lab-development-lab2.s3-website-us-east-1.amazonaws.com";

  declare local var.fastly_req_do_shield BOOL;
  set var.fastly_req_do_shield = (req.restarts == 0);

  # default conditions
  set req.backend = F_AWS_S3_hosting;
